...
import com.android.component.pageIndicatorView.animation.type.*;
...
import com.android.component.pageIndicatorView.draw.data.PositionSavedState;
import com.android.component.pageIndicatorView.draw.data.RtlMode;
import com.android.component.pageIndicatorView.utils.CoordinatesUtils;
import com.android.component.pageIndicatorView.utils.DensityUtils;
import com.android.component.pageIndicatorView.utils.IdUtils;

public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener, com.android.component.pageIndicatorView.IndicatorManager.Listener, ViewPager.OnAdapterChangeListener, View.OnTouchListener {

    private static final Handler HANDLER = new Handler(Looper.getMainLooper());

    private com.android.component.pageIndicatorView.IndicatorManager manager;
    ...
    /**
     * Fade on idle will make {@link com.android.component.pageIndicatorView.PageIndicatorView} {@link View#INVISIBLE} if {@link ViewPager} is not interacted
     * in time equal to {@link Indicator#idleDuration}. Take care when setting {@link com.android.component.pageIndicatorView.PageIndicatorView} alpha
     * manually if this is true. Alpha is used to manage fading and appearance of {@link com.android.component.pageIndicatorView.PageIndicatorView} and value you provide
     * will be overridden when {@link com.android.component.pageIndicatorView.PageIndicatorView} enters or leaves idle state.
     *
     * @param fadeOnIdle boolean value to hide {@link com.android.component.pageIndicatorView.PageIndicatorView} when {@link ViewPager} is idle
     */
     ...
     * If {@link Indicator#fadeOnIdle} is true, {@link com.android.component.pageIndicatorView.PageIndicatorView} will
    ...
    private void initIndicatorManager(@Nullable AttributeSet attrs) {
        manager = new com.android.component.pageIndicatorView.IndicatorManager(this);
