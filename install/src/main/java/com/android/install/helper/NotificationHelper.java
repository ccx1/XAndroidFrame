package com.android.install.helper;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static String CHANNEL_ID = "x_android_app_update";
    ...
    public void showNotification(String content, String apkUrl) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(this,    0, new Intent(), PendingIntent.FLAG_UPDATE_CURRENT);
